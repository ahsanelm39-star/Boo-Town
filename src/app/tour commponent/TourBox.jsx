...
function TourBox({image,title}) {
    return (
        <div className="w-80 2xl:w-100 max-sm:w-1/1 h-fit shadow-lg transition duration-300  hover:shadow-2xl overflow-hidden tour_box">
            <div>
                <div  className="w-1/1 h-[210px] max-sm:h-[270px] relative">
                    <span className="tour_box_span absolute bg-[#4500e766] w-1/1 h-1/1  top-0 -left-1/1 rounded-t-md transition duration-300"></span>
                    <Image src={image} alt="tour iamge" className="w-1/1 h-1/1 rounded-t-md"/>
                </div>
