    ...
    return (
        <>
            ...
            <div className='my-14'>
                ...
                <div className="container flex justify-center gap-10 items-center max-md:flex-wrap">
                    ...
                    <form className='bg-[#eee] w-1/1 md:w-140 rounded-2xl flex flex-col gap-4 p-6 border border-[#ddd]'>
                        <input type="text" placeholder='Full Name' className='h-12 w-1/1 rounded-full bg-white border border-[#ccc] pl-4 p' required/>
                        <input type="email" placeholder='Email Adress' className='h-12 lg:h-14 w-1/1 rounded-full bg-white border border-[#ccc] pl-4 p' required/>
                        <input type="text" placeholder='Phone Number' className='h-12 lg:h-14 w-1/1 rounded-full bg-white border border-[#ccc] pl-4 p' required/>
                        <input type="text" placeholder='Subject' className='h-12 lg:h-14 w-1/1 rounded-full bg-white border border-[#ccc] pl-4 p' />
                        <textarea value={'Message'} className='text-[#9a9a9ad0] bg-white h-22 lg:h-28 rounded-3xl p-4 outline-0'></textarea>
