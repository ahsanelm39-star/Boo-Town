...
function TourFilter() {
    return (
        <section className="py-13">
            <div className="container ect flex justify-between gap-10 max-xl:flex-col">
                <div> 
                    ...
                    <div className="max-xl:flex sm:gap-8 box_filter max-sm:flex-wrap max-sm:justify-center">
                        <ul className="w-100 2xl:w-116 max-sm:w-1/1 p-4 pl-0 pb-1 rounded-md bg-[#eee] mt-8">
                            <h3 className="font-medium text-2xl pl-3">Destination</h3>
                            <li className="flex justify-between border-b  py-3 pl-3 border-[#7474748e] transition duration-300 hover:bg-[#ddd] ">
                            ...
                            <li className="flex justify-between border-b pl-3  transition duration-300 hover:bg-[#ddd] py-3 border-[#7474748e]">
                                <div className="flex items-center gap-2">
                            ...
                            <li className="flex justify-between py-3 pl-3 transition duration-300 hover:bg-[#ddd] ">
                                <div className="flex items-center gap-2">
                        ...
                        <ul className="w-100 2xl:w-116 max-sm:w-1/1 p-4 pl-0 pb-1 rounded-md bg-[#eee] mt-8">
                            <h3 className="font-medium text-2xl ml-3">Activities</h3>
                            <li className="flex justify-between border-b py-3 pl-3 transition duration-300 hover:bg-[#ddd] pb-3 border-[#7474748e]">
                                <div className="flex items-center gap-2">
                        ...
                        <ul className="w-100 2xl:w-116 max-sm:w-1/1 p-4 pl-0 pb-1 rounded-md bg-[#eee] mt-8 max-lg:hidden">
                            <h3 className="font-medium text-2xl ml-3">Trip Types</h3>
                            <li className="flex justify-between border-b py-3 pl-3 transition duration-300 hover:bg-[#ddd]  pb-3 border-[#7474748e]">
                                <div className="flex items-center gap-2">
                            ...
                            <li className="flex justify-between pt-3 py-3 pl-3 transition duration-300 hover:bg-[#ddd] ">
                                <div className="flex items-center gap-2">
