...
const Testimonials = ()=> {
    const data = [
        {
            image:'/images/tst-3.webp',
            name:'TASHA STEWART'
        },
        {
            image:'/images/tst-1.webp',
            name:'Ali ahmed'
        },
        {
            image:'/images/tst-2.webp',
            name:'Mona mohamed'
        },
    ]
    return (
        <section className='py-14 relative'>
            <Image src={'/images/test-bg.webp'} width={250} height={250} alt='image'  className='max-md:hidden absolute h-1/1 right-0 top-0 z-[-1]'/>
            <Image src={'/images/test-bg.webp'} width={250} height={250} alt='image'  className='max-md:hidden absolute h-1/1 left-0 top-0 -rotate-180 z-[-1]'/>
                        ...
                        <SwiperSlide key={idx} className='py-20'>
                            <div className="collect flex justify-center gap-14 relative max-md:flex-col max-md:items-center">
                                <div className='bg-[#2bcebbd1] max-sm:w-70 w-80 rounded-r-xl relative h-70 test_box'>
                                    <Image src={'/images/tst-image-1.webp'} width={400} height={400} alt='image' className='w-70 absolute -top-18 -left-10'/>
                                </div>
                                <div className='md:w-100 md-mt-6 max-md:px-4'>
                                    ...
                                    <div className='flex gap-4 items-center'>
                                        <div className='mt-4 p-1 border border-blue w-fit rounded-full' >
                                            <Image src={owner.image} width={200} height={200} alt='image' className='w-14 h-14 rounded-full' />
                                        </div>
